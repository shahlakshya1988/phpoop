    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <form name="add_user" action="" enctype="multipart/form-data" method="POST">
                <div class="col-md-5 thumbnail user_image_box">
                ...
                <div class="col-md-7">
                    ...
                    <div class="info-box-footer clearfix">
                        <a id="user_id" href="delete_user.php?id=<?php echo $user->id ?>" class="btn btn-danger" data-user-id="<?php echo $user->id ?>" >Delete User</a>
